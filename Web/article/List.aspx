<%@ Page Title="article" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Movie.Web.article.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="cateid" HeaderText="cateid" SortExpression="cateid" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="isimage" HeaderText="isimage" SortExpression="isimage" ItemStyle-HorizontalAlign="Center"  /> 
