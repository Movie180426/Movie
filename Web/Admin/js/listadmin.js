...
var mygrid = {
    ...
    gridBind: function () {
        grid.datagrid({
            url: '../Controler/grid.ashx?action=query&tableName=admins',
        ...
        $('#dataadd').dialog({
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "../Controler/admin.ashx?action=AddAdmin",
        ...
        $('#dataedit').dialog({
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "../Controler/admin.ashx?action=EditAdmin",
    ...
    gridDelet: function (id) {
        $.messager.confirm('删除', '是否确认删除?', function (r) {
            if (r) {
                $.ajax({
                    type: "GET",
                    url: "../Controler/grid.ashx?action=delete&tableName=admins",
                    data: { id: id },
                    dataType: "json",
                    success: function (data) {
                        $.messager.show({
