<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Movie.Web.login" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $("#submit").click(function () {
            var options = {
                url: "TopicHandler.ashx?Mth=login",   //同action 
                type: 'post',
...
<body>
    ...
    <div id="content">
        ...
        <form action="TopicHandler.ashx?Mth=login" method="post" name="myform" id="myform"
            onsubmit="return reg();">
            <div class="col-left form-login form-reg">
                ...
                <div class="reg">
                    <div class="submit">
                        <input type="submit" id="submit" value=" 确  定 " />
                    </div>
                    <br />
