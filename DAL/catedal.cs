...
namespace Movie.DAL
{
    ...
    public partial class catedal
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "cate");
        }
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Movie.Model.cate model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Movie.Model.cate model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Movie.Model.cate GetModel(int id)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Movie.Model.cate DataRowToModel(DataRow row)
        {
            Movie.Model.cate model = new Movie.Model.cate();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,catename ");
            strSql.Append(" FROM cate ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from cate T ");
